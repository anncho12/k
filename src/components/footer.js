    ...
    return (
        <footer class="border-t relative bg-white">
            <div class="pt-4 pb-16 max-w-screen-lg m-auto">
                <div class="flex w-full justify-between mb-4">
                    <div class="flex">
                        ...
                        <div id="company-information">
                            <FooterLink name="기업소개" link="naver.com"/>
                            <FooterLink name="이용약관" link="naver.com"/>
                            <FooterLink name="고객센터" link="naver.com"/>
                            <FooterLink name="개인정보 처리방침" link="naver.com"/>
                        </div>
                    </div>
                    <div>
                        SNS
                ...
                <div class="max-w-screen-lg border-t m-auto pt-6">
